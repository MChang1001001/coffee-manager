...
CREATE TABLE IF NOT EXISTS coffee_beans (
    ...
    summary_title VARCHAR(128) DEFAULT NULL COMMENT '一句话评测总结',
    flavor_summary TEXT DEFAULT NULL COMMENT '风味总结',
    brew_suggestion TEXT DEFAULT NULL COMMENT '冲煮建议',
    repurchase_intention VARCHAR(32) DEFAULT NULL COMMENT '回购意向',
    summary_text TEXT DEFAULT NULL COMMENT '评测总结正文',
    summary_source VARCHAR(16) DEFAULT NULL COMMENT '总结来源：MANUAL/AI',
    summary_generated_at DATETIME DEFAULT NULL COMMENT 'AI总结生成时间',
